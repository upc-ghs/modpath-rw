...
! Set default access status to private
  private
    ...
    !type,public :: ParticleTrackingEngineType
      ...
      ! FLOWMODEL
      logical,allocatable,dimension(:) :: SubFaceFlowsComputed
...
!end subroutine pr_GetVolumetricBalanceSummary
    ...
    !---------------------------------------------------------------------------------------------------------------
        ...
        if(arraySize .ne. this%Grid%CellCount) then
            write(*,*) "FlowModel: The IBound array size does not match the cell count for the grid. stop"
            stop
        end if
    ...
    !---------------------------------------------------------------------------------------------------------------
        ...
        if(arraySize .ne. this%Grid%CellCount) then
            write(*,*) "FlowModel: The Zones array size does not match the cell count for the grid. stop"
            stop
        end if
    ...
    !---------------------------------------------------------------------------------------------------------------
        ...
        if(arraySize .ne. this%Grid%CellCount) then
            write(*,*) "FlowModel: The Porosity array size does not match the cell count for the grid. stop"
            stop
        end if
    ...
    !---------------------------------------------------------------------------------------------------------------
        ...
        if(arraySize .ne. this%Grid%CellCount) then
            write(*,*) "FlowModelType: The Retardation array size does not match the cell count for the grid. stop"
            stop
        end if
...
!!---------------------------------------------------------------------------------------------------------------
!  implicit none
!  class(FlowModelType),target :: this
