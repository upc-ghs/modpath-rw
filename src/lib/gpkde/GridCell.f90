module GridCellModule
  ...
  type GridCellType
    ...
    ! Kernel matrices
    real(fp), dimension(:,:,:), pointer :: kernelSigmaMatrix
    real(fp), dimension(:,:,:), pointer :: kernelMatrix
    real(fp), dimension(:,:,:), pointer :: kernelSDMatrix
    real(fp), dimension(:,:,:), pointer :: kernelSD1Matrix
    real(fp), dimension(:,:,:), pointer :: kernelSD2Matrix
    real(fp), dimension(:,:,:), pointer :: kernelSD3Matrix
